<x-app-layout>
    ...
    <form method='Post' action="{{route('store.item')}}" enctype="multipart/form-data">
        ...
        <div class="form-row">
            ...
            <input type="text" class="form-control" id="inputEmail4" name='item_name' placeholder="name" required>
            </div>
            <div class="form-group col-md-6">
        ...
        <div class="form-group">
            ...
            <input type="text" class="form-control" id="inputAddress2" name='description' placeholder="description" required>
        </div>
        <div class="form-row">
            <div class="form-group col-md-6">
