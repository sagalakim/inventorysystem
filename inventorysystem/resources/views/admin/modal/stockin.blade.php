...
<form id="agentstockinForm" action="{{route('stockin')}}" action='Post' enctype="multipart/form-data" class="w-full max-w-lg">
  ...
  <div class="flex flex-wrap -mx-3">
    <div class="w-full md:w-1/2 px-3  md:mb-0">
      ...
      <input class="appearance-none block w-full bg-gray-200 text-gray-700 border border-red-500 rounded py-3 px-4 mb-3 leading-tight focus:outline-none focus:bg-white" id="grid-first-name" name='stockno' type="number" placeholder="Fill in">
    </div>
    <div class="w-full md:w-1/2 px-3">
